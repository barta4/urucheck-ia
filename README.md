...
## 🐳 Imágenes Docker Hub (v2.14 / v2.11)

* **Backend API**: `docker.io/alfredobartaburu/urucheck-backend:v2.14` (y `latest`)
* **Frontend Admin**: `docker.io/alfredobartaburu/urucheck-frontend:v2.11` (y `latest`)
